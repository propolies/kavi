...
{#if vault.showVault}
  <div
    out:fade={{ duration }}
    in:fade={{ duration }}
    class="fixed w-full h-screen z-30 bg-black/60 backdrop-blur-xs"
  ></div>
  <div
    ...
    class="fixed w-full h-[80%] bottom-14 z-30 body-overflow-hidden bg-gray-900 pt-6 rounded-t-2xl overflow-hidden"
  >
